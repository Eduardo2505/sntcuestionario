...
define('PS_SHOP_PATH', 'https://sntcenter.com.mx/planes/');		// Root path of your PrestaShop store
define('PS_WS_AUTH_KEY', 'ILTWHBCKAQUNZT4SD76R6PRB2UAWHS6M');	// Auth key (Get it in your Back Office)
...
if (isset($resources))
{
	...
	else
	{
		foreach ($resources as $key => $resource)
		{
			...
			echo '<tr>';
			echo '<th>'.$key.'</th><td>'.$resource.'</td><td>'.$resourcessx.'</td>';
			echo '</tr>';
		}
	}
}
