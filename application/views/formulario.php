								...
								<div class="dzen-accordion" data-expanded="3" role="tablist">
									...
									<div class="ui-accordion-content" id="ui-accordion-1-panel-12" aria-labelledby="ui-accordion-1-header-12" role="tabpane12" aria-expanded="false" aria-hidden="true">
										...
										<div class="dzen_column_DD_span5">
											...
											<div class="margin_bottom">
												<input type="text" name="suple1Nombre" maxlength="300" class="dzencf-text" placeholder="Nombre" >
											</div>
										</div>
										<div class="dzen_column_DD_span6">
											...
											<div class="margin_bottom">
												...
												<input type="text" name="suple1Caracteristicas" maxlength="300" class="dzencf-text" placeholder="Características" >
										...
										<div class="dzen_column_DD_span5">
											...
											<div class="margin_bottom">
												<input type="text" name="suple1Motivo" maxlength="300" class="dzencf-text" placeholder="Motivo de uso" >
											</div>
										</div>
										<div class="dzen_column_DD_span6">
											...
											<div class="margin_bottom">
												...
												<input type="text" name="suple1Tiempo" maxlength="300" class="dzencf-text" placeholder="Tiempo de uso" >
										...
										<div class="dzen_column_DD_span5">
											...
											<div class="margin_bottom">
												<input type="text" name="suple1Cantidad" maxlength="300" class="dzencf-text" placeholder="Cantidad usada" >
											</div>
										</div>
									</div>
									<!-- fin -->
